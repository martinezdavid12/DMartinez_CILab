# second implementation of naive hash NeRF 
import os
import torch
import torchvision
...
initial_state = saveModel(model_0, 0, 0) # actually stores statedict and returns path of statedict!

#replace with len of video
for t in range(0, numFrames):
    model_0.load_state_dict(torch.load(initial_state))
    model_0.train()
